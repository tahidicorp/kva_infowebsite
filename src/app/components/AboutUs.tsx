  ...
  return (
    <div className="bg-gradient-to-b from-white to-gray-50 text-gray-800 overflow-hidden">
      ...
      <section className="text-center px-4 sm:px-6 md:px-10 py-14 sm:py-16 md:py-20 relative">
        ...
        >
          At <span className="font-semibold">Mizan Investments</span>, we are more than a business — we are a
          mission-driven team committed to empowering communities through innovative solutions in{" "}
